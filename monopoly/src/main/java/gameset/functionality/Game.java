...
//    }
    ...
    /**
     * Used to set the player order. This is intended to be called by the DeterminePlayerOrder class under the
     * screen package.
     * @param sortedPlayerList The player list in sorted order of who goes first -> last
     */
    public void setPlayerOrder(ArrayList<Player> sortedPlayerList) {
